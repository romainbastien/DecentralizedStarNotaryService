...
contract StarNotary is ERC721Full {
    ...
    constructor() ERC721Full("Romain Star Notary", "RSN") public {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender , "You must own at least one of the two token");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You have to own the star to transfer it");
